classdef ResponseParameterClass
    % ResponseParameterClass   Class for storing information about a particular
    % ResponseParameter
    %
   ...
   methods
       ...
       function obj = scalegradients(obj,noisefactormean,noisefactorid)
           ...
           %    noisefactormean : relevant noise factor id
       ...
       function obj = combinegradients(obj)
            % take magnitude of all gradients for each response parameter
            mag = 0;
